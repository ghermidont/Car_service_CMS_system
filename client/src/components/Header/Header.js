        ...
        <div className="container mx-auto h-32 flex justify-between items-center">
          <div className='flex bg-gray-100 rounded-full shadow-md overflow-hidden shadow-shadow'>
            <button className='px-1.5 py-0.5 bg-gray'>
              <svg class="w-6 h-6" fill="none" stroke="currentColor" color="#fff" viewBox="0 0 24 24"
          ...
          <div className='flex items-center'>
            ...
            <div className='flex items-center mx-14'>
              <div className='w-60 h-14 rounded-full overflow-hidden mr-4'>
                <img className=' bg-green rouded' src="" alt=""/>
              </div>
              <span className='font-normal uppercase hover:opacity-70 focus:opacity-70'><a href="#">My Data</a></span>
            </div>
            <div>
              <button className='flex items-center text-xl text-white bg-blue uppercase py-1 px-4 mr-4 rounded transition hover:opacity-70 focus:opacity-70'>Log Out</button>
            </div>
          </div>
        </div>
      </header>
