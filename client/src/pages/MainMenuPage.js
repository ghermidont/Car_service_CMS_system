            ...
            <div className='min-h-screen flex flex-col justify-between'>   
                <main className='flex items-center'>
                  ...
                  GESTIONE TALIANDI
                        ...
                        <Link to="/" className='text-2xl text-center font-bold bg-grayL uppercase max-w-600 w-100% py-16 rounded shadow-shadow focus:outline-none transition duration-300 hover:bg-border hover:text-white focus:text-white focus:bg-border'>
                  NOTE INTERNE
                        </Link>
