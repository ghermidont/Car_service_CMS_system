  ...
  return (  
      <main className='mb-12'>
         <label className='block mb-2 text-xl' style={{float: "right", paddingRight: "10px"}}>
          <Link to="/cars_list">Click to go to &rArr; Cars List Page</Link>
        </label>
        {/* <h1>CarArchive.js</h1>  */}
          ...
          <div className='py-20 rounded-3xl bg-grayL shadow-shadow  mt-16 mb-10'>
            <table className='mx-auto mb-8'>
              ...
              <tr>
                ...
                <th> </th>
                <th
                  className='px-1 py-1.5 w-75 bg-blue border border-border text-2xl text-white font-normal uppercase'>ID
                </th>
                <th
                ...
                <th
                  className='px-6 py-1.5 w-200 bg-blue border border-border text-2xl text-white font-normal uppercase'>REVISIONE
                </th>
                <th
                  className='px-6 py-1.5 w-200 bg-blue border border-border text-2xl text-white font-normal uppercase'>KM
                </th>
                <th
                  className='px-6 py-1.5 w-200 bg-blue border border-border text-2xl text-white font-normal uppercase'>ANNO
                </th>
                <th
                  className='px-6 py-1.5 w-200 bg-blue border border-border text-xl text-white font-normal uppercase'>Cliente
                </th>
              </tr>
              </thead>
              <tbody>
