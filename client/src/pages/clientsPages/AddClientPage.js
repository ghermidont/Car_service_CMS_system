            ...
            <form className='text-lg' action="">
              <div className='flex flex-col'>
                ...
                <label className='font-normal uppercase mb-3'>Nome
                  <input className='text-xl h-9 px-4 mt-1 border border-border rounded-lg focus:outline-none bg-grayL max-w-400 w-100% block' type="text"/>
                </label>
                ...
                <label className='font-normal uppercase mb-3'>Data
                  <input className='text-xl h-9 px-4 mt-1 border border-border rounded-lg focus:outline-none bg-grayL max-w-400 w-100% block' type="date"/>
                </label>
                ...
                <div className='flex justify-between mb-6'>
                  ...
                  <label className='font-normal uppercase mb-3 max-w-400 w-100%'>Indirizzo
                    <input className='text-xl h-9 px-4 mt-1 border border-border rounded-lg focus:outline-none bg-grayL w-100% block' type="text"/>
                  </label>
