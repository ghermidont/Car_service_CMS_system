...
export default function DateCars() {
  return (
    <>
          ...
          <div className="container mx-auto">
            <div className='py-20 rounded-3xl bg-grayL shadow-shadow  mt-16 mb-10'>
              <table className='mx-auto mb-8'>
                ...
                <tr>
                  ...
                  <th></th>
                  <th></th>
                  <th className='px-1 py-1.5 w-75 bg-blue border border-border text-2xl text-white font-normal'>ID</th>
                  <th className='px-6 py-1.5 w-200 bg-blue border border-border text-2xl text-white font-normal'>Data</th>
                  <th className='px-6 py-1.5 w-200 bg-blue border border-border text-2xl text-white font-normal'>Targa
                  </th>
                  <th className='px-6 py-1.5 w-200 bg-blue border border-border text-2xl text-white font-normal'>Marca
                  </th>
                  <th className='px-6 py-1.5 w-200 bg-blue border border-border text-2xl text-white font-normal'>Modello
                  </th>
                  <th className='px-6 py-1.5 w-200 bg-blue border border-border text-2xl text-white font-normal'>Stato
                  </th>
                </tr>
                </thead>
                <tbody>
            ...
            <div className='flex justify-between mx-8'>
              ...
              <form className='w-300 flex items-center relative'>
                ...
                <span className='text-sm text-red block absolute right-0 -bottom-8'>
                id-nome-targa
              </span>
              </form>
            </div>
