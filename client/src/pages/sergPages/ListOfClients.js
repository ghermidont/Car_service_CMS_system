          ...
          <div className='py-20 rounded-3xl bg-grayL shadow-shadow  mt-16 mb-10'>
            <table className='mx-auto mb-8'>
              ...
              <tr>
                ...
                <th
                  className='px-6 py-1.5 w-200 bg-blue border border-border text-2xl text-white font-normal uppercase'>Nome
                </th>
                <th
                  className='px-6 py-1.5 w-200 bg-blue border border-border text-2xl text-white font-normal uppercase'>Cognome
                </th>
                <th
                  className='px-6 py-1.5 w-200 bg-blue border border-border text-2xl text-white font-normal uppercase'>Cellulare
                </th>
                <th
                  className='px-6 py-1.5 w-300 bg-blue border border-border text-2xl text-white font-normal uppercase'>ELENCO
                  VENTTURE
                </th>
              </tr>
              </thead>
