    ...
    return (
        <main>
            ...
            <div className="container mx-auto">
                ...
                <div className="py-20 rounded-3xl bg-grayL shadow-shadow overflow-auto mt-16 mb-10">
                                    ...
                                    <tr key={client.slug}>
                                        <td>
                                            <Link to={`/client/${client.slug}`}>
                                                <button
                                                    className="w-75 h-8 m-1 bg-green flex justify-center items-center text-white uppercase rounded hover:opacity-80 uppercase">
                                                Open
                                                </button>
                                            </Link>
                                        </td>
